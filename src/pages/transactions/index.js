...
export default function Transactions() {
    ...
    return (
        <div className=" w-[90%] m-auto">
            ...
            <div className=" border-b my-8 flex max-w-[100%] hideScrollBar overflow-x-scroll justify-between border-zinc-700 items-center gap-3">
            ...
            {
                !isCurrent && (
                    <div className=" depositBannerBg smm:text-center pt-8 pb-40">
