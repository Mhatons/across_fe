...
export default function AirdropDetails() {
    ...
    const details = [
        ...
        },
        {
            ...
            volume: "70,000,000",
            desc: "Liquidity providers who pool ETH, USDC, WBTC or DAI into the defi protocol protocol before the token launch. The amount of rewards to LPs are pro-rated by size and a fixed amount of tokens will be emitted at each block since the inception of the protocol."
        },
    ]
    return (
        <div className=" mdd:w-[85%] w-[90%] m-auto text-zinc-200 lg:flex items-center justify-between ">
            <div className="lg:w-[45%] mdd:w-[450px]">
                ...
                <div className="mdd:pt-10 pt-5">
                    ...
                    <div className="text-zinc-300 max-mdd:text-[13.5px] mdd:pt-5 pt-3">A total of 1,000,000,000 $ACX will be minted at inception and 125,000,000 $ACX will be distributed through an airdrop to users who have contributed to defi protocol.</div>
                </div>
            </div>
